...
PRESETS = {
    ...
    'chat_5m': {
        ...
        'init_scale': 0.02,
        'description': (
            'Ultra-tiny dialogue model. ~5M params (C=256, L=6, T=128). '
            'batch=4, accum=4, seq=128. Do not resume L=4 checkpoints.'
        ),
    },
    'story_sub1m': {
        ...
        'pos_encoding': 'rope',
        'init_scale': 0.02,
        'description': 'Fast story model under 1M params. ~0.83M at BPE-256. batch=8, accum=2, seq=128.',
    },
    'tiny': {
        'name': 'Tiny (Testing)',
        'vocab_size': None,  # Inferred from tokenizer
...
class ModelConfigBuilder:
    ...
    def preset_config(self, preset_name: str) -> Dict:
        ...
        Args:
            preset_name: One of 'toy', 'tiny_stories', 'story_sub1m', 'chat_5m', 'tiny', 'small', 'medium'
    ...
    def interactive_config(self) -> Dict:
        ...
        print("  2. Fast Stories (<1M params, C=128/L=4/T=128)")
        print("  3. Tiny Stories (real run, ~3M params, C=256/L=4/T=128)")
        print("  4. Chat 5M (~5M params, C=256/L=6/T=128, dialogue)")
        print("  5. Small (development)")
        print("  6. Medium (production)")
        print("  7. Custom (full customization)")
        
        choice = input("\nSelect (1-7) [default=1]: ").strip()
