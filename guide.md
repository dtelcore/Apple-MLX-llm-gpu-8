...
Current release: **v0.0.9** — unguided trainer + autotrainer daemon + train monitor (`trainmon.py` / App Train tab) + generate prober at `max_steps` (`unguided_prober.py`). **v0.0.8** — App.py + related cabinet follow-ups + pick-a-neuron;
