...
Shared helpers for NumPy (reference) vs MLX (DUT) comparisons.
"""
...
# Tiny shapes safe for the 2 GB process budget on 8 GB unified memory
B = 2
T = 8
C = 32
H = 4
...
class CudaTestCase(unittest.TestCase):
    """Skip suite cleanly when MLX / Metal is unavailable."""

    @classmethod
    def setUpClass(cls) -> None:
        try:
            from model.mlx import ops as cuda_ops  # noqa: F401
