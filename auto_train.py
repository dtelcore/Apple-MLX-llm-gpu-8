...
with train.py. Smoke generate writes output/logs/generate_<checkpoint>_<timestamp>.log
(same helper as generate.py).
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Interactive wizard + flag-group picker (incl. smoke-generate / decode flags). "
